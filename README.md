...
PI-MAE was developed using [Tensorflow (version 2)](https://www.tensorflow.org/install) and [Python (version 3.10)](https://www.python.org/downloads/release/python-3100/) with [Anaconda Jupyter Lab](https://github.com/jupyterlab/jupyterlab) on an [AWS SageMaker](https://aws.amazon.com/sagemaker/) instance with one NVIDIA T4 16GB GPU.
